...
- 📅 **Investimento lançado direto na aba Investimentos conta no mês certo** — aporte inicial (ou valor atual informado, se o aporte ficar zerado) de uma categoria com Data de início no mês atual entra no Investimentos/Sobra do Mês, do Dashboard e do Anual — sem precisar lançar de novo pelo formulário
